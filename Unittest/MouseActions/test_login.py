...
class LoginTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if self.user is None or self.password is None:
            raise ValueError("No se pudieron cargar las variables de entorno" 
                             "ADMIN y PASSWORD desde el archivo .env")
    ...
    #     job_categories = f.validate_element("tag", Locator.categories)
