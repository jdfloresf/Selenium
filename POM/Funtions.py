...
class Functions:
    ...
    def validate_by_locator(self, locator_type, locator, text, t):
    ...
    def click_element_by_locator(self, locator_type, locator, t):
    ...
    def select_by_type(self, locator_type, locator, select_type, element, t):
    ...
    def upload_file(self, locator_type, locator, file_path, t):
    ...
    def exit_element(self, locator_type, locator, t) -> str:
